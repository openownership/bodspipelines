...
lei_source = Source(name="lei",
                     origin=BulkData(display="LEI-CDF v3.1",
                                     ...
                                     url=gleif_download_link("https://goldencopy.gleif.org/api/v2/golden-copies/publishes/latest", "lei"),
                                     size=41491,
                                     directory="lei-cdf"),
...
rr_source = Source(name="rr",
                   origin=BulkData(display="RR-CDF v2.1",
                                   ...
                                   url=gleif_download_link("https://goldencopy.gleif.org/api/v2/golden-copies/publishes/latest", "rr"),
                                   size=2823,
                                   directory="rr-cdf"),
...
repex_source = Source(name="repex",
                      origin=BulkData(display="Reporting Exceptions v2.1",
                                      ...
                                      url=gleif_download_link("https://goldencopy.gleif.org/api/v2/golden-copies/publishes/latest", "repex"),
                                      size=3954,
                                      directory="rep-ex"),
...
output_new = NewOutput(storage=ElasticStorage(indexes=index_properties),
                       output=KinesisOutput(stream_name="gleif-dummy-dev")) #gleif-prod-alt4"))
...
gleif_source = Source(name="gleif",
                      origin=KinesisInput(stream_name="gleif-dummy-dev"), #gleif-prod-alt4"),
                      datatype=JSONData())
...
bods_output_new = NewOutput(storage=ElasticStorage(indexes=bods_index_properties),
                            output=KinesisOutput(stream_name="bods-dummy-dev"), #bods-gleif-prod-alt6"),
